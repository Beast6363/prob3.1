...
class Predator {
    ...
    mul() {
        ...
        if (newCell && this.multiply >= 30) {
            ...
            var newGrassEather = new Predator(newX, newY, 1);
            predatorArr.push(newGrassEather);
            this.multiply = 0;
        }
    }
...
class Predator2 {
    ...
    mul() {
        ...
        if (newCell && this.multiply >= 26) {
            ...
            var newPredator = new Predator2(newX, newY, 1);
            predator2Arr.push(newPredator);
            this.multiply = 0;
        }
    }
